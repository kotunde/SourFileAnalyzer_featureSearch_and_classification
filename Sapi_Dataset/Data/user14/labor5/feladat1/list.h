...
#ifndef LANCOLT_LISTA_LIST_H
#define LANCOLT_LISTA_LIST_H
...
to remove. The enum values are accessed with List::DeleteFlag::LESS,..., outside the class */
    enum class
    DeleteFlag {
        LESS, EQUAL, GREATER
    };
...
bool comp(List*, list<int>);

#endif //LANCOLT_LISTA_LIST_H

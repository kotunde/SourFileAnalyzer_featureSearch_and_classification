...
//Index operator
    ...
    Matrix m6(m4);
    cout
            << "m6 created as a copy of m4 using copy constructor: " <<endl<< m6 << endl;
    try{
        cout<<"m1 = m6 = m6"<<endl;
        m1 = m6 = m6;
    }
    ...
    ///Ez is kellene működjön, de mégsem hívódik meg a Move konstruktor
    ///De nem is kell meghivodjon a move kontruktor igazabol...
    Matrix mz2 = createSquareMatrix(3);
    cout << "Matrix mz2 = createSquareMatrix(3)\n";

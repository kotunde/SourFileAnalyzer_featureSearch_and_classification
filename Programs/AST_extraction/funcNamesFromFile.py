#Extracts function names from a .cpp file, and saves in a .txt file with the same name 
#Usage: python funcFromFile.py /path/to/source/file/sourceFileName.cpp sourceFileName.cpp
#Usage clang-check: /yourDirectory/clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-18.04/bin/clang-check -extra-arg=-std=c++1y -ast-dump -ast-dump-filter=main simple.cpp
...
#process file line by line and find function names
...
#if we find operator overloading method in a file
#since we couldn't write a regex to find the whole function name
#we will programatically generate the most frequestly used of them

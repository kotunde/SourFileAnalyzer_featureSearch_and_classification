...
def createAst(funcName,fileName,output):
	command = "yourDirectory/clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-18.04/bin/clang-check -extra-arg=-std=c++1y -ast-dump -ast-dump-filter="+funcName+" "+ fileName + " -- >> " + output
...
#read function names line by line from input file
